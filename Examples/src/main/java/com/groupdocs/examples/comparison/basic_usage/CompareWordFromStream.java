...
/**
 * This example demonstrates comparing of two Word documents
 */
public class CompareWordFromStream {
    public static Path run(Path sourceFile, Path targetFile) {

        final Path outputPath = FilesUtils.makeOutputPath("CompareWordFromStream" + obtainExtension(sourceFile));
