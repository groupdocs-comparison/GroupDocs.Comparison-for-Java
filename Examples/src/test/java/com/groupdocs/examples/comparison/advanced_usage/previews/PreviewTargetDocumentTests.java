...
public class PreviewTargetDocumentTests extends TestsSetUp {

    @Test
    public void testRun() {
        final Path resultPath = PreviewTargetDocument.run(SampleFiles.SOURCE_DOC, SampleFiles.TARGET_DOC);
