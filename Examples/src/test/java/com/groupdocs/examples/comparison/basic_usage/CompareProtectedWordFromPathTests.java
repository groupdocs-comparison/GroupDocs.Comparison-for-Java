...
public class CompareProtectedWordFromPathTests extends TestsSetUp {

    @Test
    public void testRun() {
        final Path resultPath = CompareProtectedWordFromPath.run(SampleFiles.SOURCE_DOCX_PROTECTED, SampleFiles.TARGET_DOCX_PROTECTED);
