...
public class CompareDocumentsSettingsStreamTests extends TestsSetUp {

    @Test
    public void testRun() {
        final Path resultPath = CompareDocumentsSettingsStream.run(SampleFiles.SOURCE_DOC, SampleFiles.TARGET_DOC);
