...
public class AcceptRejectDetectedChangesStreamTests extends TestsSetUp {

    @Test
    public void testRun() {
        final Path resultPath = AcceptRejectDetectedChangesStream.run(SampleFiles.SOURCE_DOC, SampleFiles.TARGET_DOC);
