...
public class LoadDocumentFromLocalDiscTests extends TestsSetUp {

    @Test
    public void testRun() {
        final Path resultPath = LoadDocumentFromLocalDisc.run(SampleFiles.SOURCE_PDF, SampleFiles.TARGET1_PDF);
