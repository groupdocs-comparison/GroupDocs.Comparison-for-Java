...
Download [source code](https://github.com/groupdocs-comparison/GroupDocs.Comparison-for-Java/releases/download/v23.5/groupdocs-comparison-ktor-23.5.0.zip) from github or clone this repository.
...
```bash
curl -J -L -o release.tar.gz https://github.com/groupdocs-comparison/GroupDocs.Comparison-for-Java/releases/download/v23.5/groupdocs-comparison-ktor-23.5.0.tar
tar -xvzf release.tar.gz
cd release/comparison-ktor-23.5
