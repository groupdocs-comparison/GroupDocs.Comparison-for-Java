...
fun HomeScreen(screen: MutableState<Screen>) {
    ...
    Column(
        ...
        Text(
            ...
            text = "Desktop diff tool to compare two documents. It supports Word, Excel, PowerPoint, Pdf, Images and lots of other formats.",
            color = MaterialTheme.colors.onBackground,
        ...
        Row(horizontalArrangement = Arrangement.SpaceAround) {
            ...
            FileScreen(
                ...
                documentName = state.targetFileName,
        ...
        Row(
            ...
            Text(
                ...
                text = "By converting your files or using our service you agree with our ",
                color = MaterialTheme.colors.onBackground,
                textAlign = TextAlign.Center
            )
            Text(
