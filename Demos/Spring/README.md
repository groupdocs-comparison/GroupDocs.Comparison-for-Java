...
This Spring Boot sample is a **demonstration application**. It is provided to show how GroupDocs.Comparison can be integrated with a web UI.
...
```bash
docker run -p 8080:8080 --name my-comparison --rm groupdocs/comparison:26.5-java-openjdk8-bullseye-spring
## Open http://localhost:8080/comparison/ in your favorite browser.
```
